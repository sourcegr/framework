<?php
    ...
    use Sourcegr\Framework\Database\Freakquent\Exceptions\InvalidArgumentException;
    use stdClass;

    /**
     * Class BaseModel
     *
     * @package Sourcegr\Framework\Database\Freakquent
     */
    class BaseModel
    {
         ...
         * @throws InvalidArgumentException
         */
        public static function find(?int $id = null, $fields = '*')
        {
            return static::findBy(static::$primaryKey, $id, $fields);
        }

        /**
         * @param string   $col column to search
         * @param int|null $val value to find in th DB
         * @param string   $fields
         *
         * @return static|null
         * @throws InvalidArgumentException
         */
        public static function findBy(string $col, int $val = null, $fields = '*')
        {
            if (is_null($val)) {
                return null;
            }

            $result = static::getDB()->where($col, $val)->select($fields);
            ...
            $instance = new static();
            $instance->_fromDB($result[0]??null);
            return $instance;
        }
        ...
        /**
         * @return \Sourcegr\Framework\Database\QueryBuilder\QueryBuilder
         */
